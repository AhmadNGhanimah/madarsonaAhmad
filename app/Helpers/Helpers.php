...
if (!function_exists('generate_slug_from_string')) {
    function generate_slug_from_string($str)
    {
        if (is_null($str)) {
            return "";
        }
        ...
        $str = preg_replace("/[^a-z0-9_\sءاأإآؤئبتثجحخدذرزسشصضطظعغفقكلمنهويةى]#u/", "", $str);
