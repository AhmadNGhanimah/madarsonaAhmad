<x-default-layout>
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <a type="button" class="btn btn-primary" href="{{route('teachers.create')}}">
                        {!! getIcon('plus', 'fs-2', '', 'i') !!}
                        Add Teachers
                    </a>
    ...
    @push('scripts')
        {{ $dataTable->scripts() }}
        <script>
            remove('remove_btn', 'teachers', 'teachers-table', '{{ csrf_token() }}')

            document.getElementById('mySearchInput').addEventListener('keyup', function () {
                window.LaravelDataTables['teachers-table'].search(this.value).draw();
            });
