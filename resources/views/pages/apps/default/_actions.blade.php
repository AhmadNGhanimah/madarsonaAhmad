...
<td class="text-end">
    <a class="btn btn-sm btn-light btn-active-light-primary edit_btn" id="{{$model->id}}" title="@if(request()->routeIs('contacts.*') || request()->routeIs('subscriptions.*')) Show @else Edit @endif ">
