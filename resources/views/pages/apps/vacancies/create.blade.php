@if (isset($vacancy))
    <form action="{{ route('vacancies.update', $vacancy) }}" id="vacanciesForm" method="POST"
        ...
        @method('PUT')
        @else
            <form action="{{ route('vacancies.store') }}" method="POST" id="vacanciesForm"
                  enctype="multipart/form-data">
                @endif
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-3 mb-2">
                        ...
                        <input type="number" name="experience_years" class="form-control mb-2"
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <textarea init-editor name="details_en" id="details_en" class="form-control mb-2 h-400px"
...
@isset($vacancy)
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <textarea init-editor name="details_ar" id="details_ar" class="form-control mb-2 "
                                  placeholder="Details Ar">
@isset($vacancy)
                                {{ $vacancy->details_ar }}
                            @endisset
</textarea>
